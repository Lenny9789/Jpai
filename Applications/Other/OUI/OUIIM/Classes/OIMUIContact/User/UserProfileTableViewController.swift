...
extension UserProfileTableViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func modifyRemark() {
        let alertController = UIAlertController(title: "修改备注", message: "", preferredStyle: .alert)
    ...
    @objc func deleteFriend() {
        ...
        _viewModel.deleteFriend {[weak self] r in
            ...
            if let home = MainTabBarController.shared.viewControllers?.first as? UINavigationController,
               home.viewControllers.first is MessageController {
