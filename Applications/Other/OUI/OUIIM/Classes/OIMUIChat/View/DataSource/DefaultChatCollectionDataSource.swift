...
final class DefaultChatCollectionDataSource: NSObject, ChatCollectionDataSource {
    ...
    private func createTextCell(collectionView: UICollectionView,
        ...
        let cell = collectionView.dequeueReusableCell(
            withReuseIdentifier: TextMessageCollectionCell.reuseIdentifier,
            for: indexPath
        ) as! TextMessageCollectionCell
    ...
    @available(iOS 13, *)
    private func createURLCell(collectionView: UICollectionView, messageId: String, isSelected: Bool, indexPath: IndexPath, url: URL, date: Date, alignment: ChatItemAlignment, user: User, bubbleType: Cell.BubbleType, status: MessageUIStatus, messageType: MessageType) -> UICollectionViewCell {
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case let .message(message, bubbleType: bubbleType):
            ...
            case let .text(source):
                let cell = createTextCell(collectionView: collectionView,
                                          messageId: message.id,
                                          isSelected: message.isSelected,
                                          indexPath: indexPath,
                                          text: source.text,
                                          anchor: message.isAnchor,
                                          date: message.date,
...
extension DefaultChatCollectionDataSource: ChatLayoutDelegate {
    ...
    public func sizeForItem(_ chatLayout: CollectionViewChatLayout,
                            of kind: ItemKind,
    ...
    public func alignmentForItem(_ chatLayout: CollectionViewChatLayout,
                                 of kind: ItemKind,
    ...
    public func initialLayoutAttributesForInsertedItem(_ chatLayout: CollectionViewChatLayout,
                                                       of kind: ItemKind,
    ...
    public func finalLayoutAttributesForDeletedItem(_ chatLayout: CollectionViewChatLayout,
                                                    of kind: ItemKind,
                                                    at indexPath: IndexPath,
                                                    modifying originalAttributes: ChatLayoutAttributes) {
        originalAttributes.alpha = 0
